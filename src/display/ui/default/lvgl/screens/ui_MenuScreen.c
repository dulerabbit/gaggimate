...
lv_obj_t *ui_MenuScreen_btnManual = NULL;
// event funtions
...
void ui_event_MenuScreen_btnManual(lv_event_t *e) {
    lv_event_code_t event_code = lv_event_get_code(e);
...
void ui_MenuScreen_screen_init(void) {
    ...
    ui_MenuScreen_btnManual = lv_btn_create(ui_MenuScreen_contentPanel1);
    lv_obj_set_width(ui_MenuScreen_btnManual, 120);
    lv_obj_set_height(ui_MenuScreen_btnManual, 120);
    lv_obj_set_align(ui_MenuScreen_btnManual, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_MenuScreen_btnManual, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
    lv_obj_clear_flag(ui_MenuScreen_btnManual, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_bg_color(ui_MenuScreen_btnManual, lv_color_hex(0xFAFAFA), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_MenuScreen_btnManual, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_src(ui_MenuScreen_btnManual, &ui_img_manual_pressure_80x80, LV_PART_MAIN | LV_STATE_DEFAULT);
    ui_object_set_themeable_style_property(ui_MenuScreen_btnManual, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_IMG_RECOLOR,
                                           _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_MenuScreen_btnManual, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_BG_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);
    ui_object_set_themeable_style_property(ui_MenuScreen_btnManual, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_SHADOW_COLOR,
                                           _ui_theme_color_Dark);
    ui_object_set_themeable_style_property(ui_MenuScreen_btnManual, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_SHADOW_OPA,
                                           _ui_theme_alpha_Dark);
    lv_obj_set_style_shadow_width(ui_MenuScreen_btnManual, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_spread(ui_MenuScreen_btnManual, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_event_cb(ui_MenuScreen_btnManual, ui_event_MenuScreen_btnManual, LV_EVENT_ALL, NULL);
