...
lv_obj_t *ui_dials_create(lv_obj_t *comp_parent) {
    ...
    lv_obj_set_style_shadow_width(cui_tempTarget, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(cui_tempTarget, lv_color_hex(0x0A0D14), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(cui_tempTarget, LV_OPA_90, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_object_set_themeable_style_property(cui_pressureTarget, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR_OPA,
                                           _ui_theme_alpha_NiceWhite);
    lv_obj_set_style_shadow_width(cui_pressureTarget, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(cui_pressureTarget, lv_color_hex(0x0A0D14), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(cui_pressureTarget, LV_OPA_90, LV_PART_MAIN | LV_STATE_DEFAULT);
