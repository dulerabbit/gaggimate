...
class Settings {
  public:
    ...
    int getTargetManualTemp() const { return targetManualTemp; }
    float getTargetManualPressure() const { return targetManualPressure; }
    ...
    void setTargetManualTemp(int target_manual_temp);
    void setTargetManualPressure(float target_manual_pressure);
  ...
  private:
    ...
    int targetManualTemp = 93;
    float targetManualPressure = 6.0f;
