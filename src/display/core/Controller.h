...
class Controller {
  public:
    ...
    void raiseManualPressure();
    void lowerManualPressure();
    void adjustManualPressure(float deltaBar);
    void activate();
    void deactivate();
    void clear();
    void activateGrind();
  ...
  private:
    ...
    static const unsigned long CONTROLLER_RECONNECT_INTERVAL_MS = 4000;
