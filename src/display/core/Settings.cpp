...
Settings::Settings() {
    ...
    targetManualTemp = preferences.getInt("tmt", 93);
    targetManualPressure = preferences.getFloat("tmp", 6.0f);
...
void Settings::setTargetManualTemp(const int target_manual_temp) {
    targetManualTemp = target_manual_temp;
    save();
}

void Settings::setTargetManualPressure(const float target_manual_pressure) {
    targetManualPressure = target_manual_pressure;
    save();
}
...
void Settings::doSave() {
    ...
    preferences.putInt("tmt", targetManualTemp);
    preferences.putFloat("tmp", targetManualPressure);
